...
export default function TakeList() {
  ...
  useEffect(() => {
    ...
    takingBookService
      .takeListGetAll()
      .then((result) => setTakingBooks(result.data));
  }, []);
  return (
    <div>
      <Table celled>
      ...
      <Button as={NavLink} to="taking_book_take" color="brown">
        Kitap Al
      </Button>
      <Button as={NavLink} to="taking_book_give" color="brown">
        Kitap Ver
      </Button>
      <Button as={NavLink} to="taking_book_late_list" color="brown">
        Geç kalanları listele{" "}
      </Button>
    </div>
  );
}
